CREATE TABLE `mc_af_ator_filme` (
  ...
  INDEX `fk_mc_fil_filme_has_mc_ato_ator_mc_ato_ator1_idx` (`af_ato_ator_id` ASC) VISIBLE,
  INDEX `fk_mc_fil_filme_has_mc_ato_ator_mc_fil_filme1_idx` (`af_fil_filme_id` ASC) VISIBLE,
